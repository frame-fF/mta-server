...
float4 PixelShaderFunction(PSInput PS) : COLOR0
{
    ...
    float brightnessFactor = 0.58; // the default value is 0.10
    ...
    paintColorMid = base;
    paintColor2.r = base.g / 255 + base.b / 255;
    paintColor2.g = (base.r / 2 + base.b / 255);
    paintColor2.b = base.r / 2 + base.g / 255;

    paintColor0.r = base.r / 2 + base.g / 255;
    paintColor0.g = (base.g / 255 + base.b / 255);
    paintColor0.b = base.b / 255 + base.r / 2;

    flakeLayerColor.r = base.r / 2 + base.b / 255;
    flakeLayerColor.g = (base.g / 255 + base.r / 2);
    flakeLayerColor.b = base.b / 255 + base.g / 255;
    ...
    Color += finalColor * PS.Diffuse *2.4;
